...
TESTCASE(new_instance_with_args)
{
  ...
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(1), rb_struct_getmember(p, rb_intern("x")));
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(2), rb_struct_getmember(p, rb_intern("y")));
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(3), rb_struct_getmember(p, rb_intern("z")));
}
...
TESTCASE(instance_bracket_identifier)
{
  ...
  Struct s(define_3d_point());
  Struct::Instance p(s, args);
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(1), p[Identifier("x")].value());
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(2), p[Identifier("y")].value());
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(3), p[Identifier("z")].value());
}
...
TESTCASE(instance_bracket_name)
{
  ...
  Struct s(define_3d_point());
  Struct::Instance p(s, args);
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(1), p["x"].value());
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(2), p["y"].value());
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(3), p["z"].value());
}
...
TESTCASE(instance_bracket_index)
{
  ...
  Struct s(define_3d_point());
  Struct::Instance p(s, args);
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(1), p[0].value());
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(2), p[1].value());
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(3), p[2].value());
}
...
TESTCASE(instance_swap)
{
  ...
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(4), rb_struct_getmember(p1, rb_intern("x")));
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(5), rb_struct_getmember(p1, rb_intern("y")));
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(6), rb_struct_getmember(p1, rb_intern("z")));

  ASSERT_EQUAL(detail::Convert<int>::to_ruby(1), rb_struct_getmember(p2, rb_intern("x")));
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(2), rb_struct_getmember(p2, rb_intern("y")));
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(3), rb_struct_getmember(p2, rb_intern("z")));
}
