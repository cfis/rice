...
TESTCASE(swap)
{
  ...
  o1.swap(o2);
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(42), o2.value());
...
TESTCASE(instance_eval)
{
  Object o(Class(rb_cObject).call("new"));
  o.iv_set("@foo", 42);
  ASSERT_EQUAL(detail::Convert<int>::to_ruby(42), o.instance_eval("@foo").value());
}
...
{
  Object three = Object(detail::Convert<int>::to_ruby(3)).call("to_s");
  ASSERT_EQUAL(String("3"), three);
}

TESTCASE(call_return_rice_object)
{
  Object three = Object(detail::Convert<int>::to_ruby(1)).call("+", 2);
  ASSERT_EQUAL(Object(detail::Convert<int>::to_ruby(3)), three);
}
