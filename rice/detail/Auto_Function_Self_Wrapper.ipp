#ifndef Rice__detail__Auto_Constructor_Wrapper__ipp_
#define Rice__detail__Auto_Constructor_Wrapper__ipp_
...
Auto_Function_Self_Wrapper<Func_T, Ret_T, Arg_Ts...>::
...
template<typename Func_T, typename Ret_T, typename... Arg_Ts>
VALUE Auto_Function_Self_Wrapper<Func_T, Ret_T, Arg_Ts...>::
call(int argc, VALUE *argv, VALUE self)
{
  Data_Object<Wrapped_Function> data(detail::method_data());
  Auto_Function_Self_Wrapper<Func_T, Ret_T, Arg_Ts...>* wrapper = (Auto_Function_Self_Wrapper<Func_T, Ret_T, Arg_Ts...>*)data.get();
  ...
  try
  {
    ...
    Object selfWrapped(self);
    std::tuple<Object, Arg_Ts...> selfNativeValues = std::tuple_cat(std::tuple(selfWrapped), nativeValues);
...
#endif // Rice__detail__Auto_Constructor_Wrapper__ipp_
